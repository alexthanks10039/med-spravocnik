...
[![Tests](https://img.shields.io/badge/tests-2095%20collected-brightgreen.svg)](#-development)
...
- [Features](#features)
- [Current Project State (Russian)](docs/CURRENT_STATE_RU.md)
...
|------|---------|------|----------|
| **REST API** | `uv run python -m src.infrastructure.api.server` | 8080 | Custom agents, web apps, scripts |
...
| `/api/v1/calculators/{tool_id}/schema` | GET | Get typed input metadata for dynamic forms |
