...
🏥 **152 個經驗證的醫學計算器，涵蓋 31 個主要專科**

---

## 什麼是 Medical-Calc-MCP？

Medical-Calc-MCP 是一個 [Model Context Protocol (MCP)](https://modelcontextprotocol.io/) 伺服器，提供 **152 個經過驗證的醫學計算器**，供 Claude、GPT 等 AI 代理使用。
