...
def render_guideline_summary(locale: str, audience: str) -> str:
    ...
    if locale == "en":
        ...
        lines.extend(
            [
                ...
                if audience == "docs"
                else "- [2023-2025 detailed guideline review](https://github.com/u9401066/medical-calc-mcp/blob/main/docs/GUIDELINE_RECOMMENDED_TOOLS_2023_2025.md)",
                "- [2020-2025 historical guideline review](GUIDELINE_RECOMMENDED_TOOLS_2020_2025.md)"
                if audience == "docs"
                else "- [2020-2025 historical guideline review](https://github.com/u9401066/medical-calc-mcp/blob/main/docs/GUIDELINE_RECOMMENDED_TOOLS_2020_2025.md)",
                "",
            ]
        )
        return "\n".join(lines)
    ...
    lines.extend(
        [
            ...
            if audience == "docs"
            else "- [2023-2025 詳細指引整理](https://github.com/u9401066/medical-calc-mcp/blob/main/docs/GUIDELINE_RECOMMENDED_TOOLS_2023_2025.md)",
            "- [2020-2025 歷史整理](GUIDELINE_RECOMMENDED_TOOLS_2020_2025.md)"
            if audience == "docs"
            else "- [2020-2025 歷史整理](https://github.com/u9401066/medical-calc-mcp/blob/main/docs/GUIDELINE_RECOMMENDED_TOOLS_2020_2025.md)",
            "",
        ]
    )
    return "\n".join(lines)
